...
<table width="100%" cellpadding="0" cellspacing="0" height="423">
                <TR>
<% If tipoimg = "0" Then %>
                    <TD colspan="3" width="100%" align="center"><img src="config/imgtopo/<%= imgtopo %>" alt="" border="0"></TD>
<% Else %>
...
<% End If %>
    ...
    <tr>
        <td height="272" rowspan="2" valign="top">
...
%>
        ...
        <td height="272" rowspan="2" align="center" valign="top">
...
<!--#include file="busca_result.asp"-->
    ...
    <tr>
        <td bgcolor="<%= cCorTopoBase %>" colspan="2" height="41">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="79">&nbsp;</td>
