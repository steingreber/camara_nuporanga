...
<%
SQL = "SELECT a00id, a01nome from secretarias order by a01nome"
Set result = objConect.Execute(SQL)
Do While Not result.EOF
%>							<tr>
							    <td height="20"><img src="imagens\marcador.gif" width="14" height="19" border="0"></td>
                                <td height="25" valign="top" class="navtext"><a href="#" onClick="javascript:ajax('secretarias_view.asp?id=<%= result(0) %>','conteudo')"><%= result(1) %></a></td>
                            </tr>
<%
result.movenext
Loop
