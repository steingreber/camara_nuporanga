...
'NOME DO ARQUIVO...: pm_TELEFONES_opt.asp
'CRIADO EM.........: 8/5/2007 22:36:24
'-------------------------------------------------------------------------------
...
If acao = "1" Then
   sNome = "NOVO REGISTRO - TELEFONES"
ElseIf acao = "2" Then
   sNome = "EDITAR REGISTRO - TELEFONES"
End If
%>
<!--#include file="_cnx.asp"-->
<html>
<head>
<title>TELEFONES - PageMaster 2.0 :::.</title>
...
if (theForm.cp_A01TEXTO && !EW_hasValue(theForm.cp_A01TEXTO, "TEXT" )) {
        if (!EW_onError(theForm, theForm.cp_A01TEXTO, "TEXT", "Informe um valor para o campo LOCALIDADE"))
            return false;
    }
if (theForm.cp_A02FONE && !EW_hasValue(theForm.cp_A02FONE, "TEXT" )) {
        if (!EW_onError(theForm, theForm.cp_A02FONE, "TEXT", "Informe um valor para o campo TELEFONE"))
            return false;
    }
  return true;
}
...
<table cellpadding="0" cellspacing="0" width="610" align="center">
    ...
    <tr>
        <td" align="center" valign="top">
            <table align="center" border="1" cellspacing="0" width="610" bordercolordark="white" bordercolorlight="#808080">
                <tr>
                    <td>
<%
Dim sSel, sNot
If acao = "1" Then %>
                        ...
                        <form action="pm_TELEFONES_opt.asp?acao=4&tp=1" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
...
<TR>
       <TD><P><span class="aFontePT">LOCALIDADE<br></span><INPUT value="" class=ud_caixa style="290px" name=cp_A01TEXTO></P></TD>
       <TD><P><span class="aFontePT">TELEFONE<br></span><INPUT value="" class=ud_caixa style="290px" name=cp_A02FONE></P></TD>
</TR>
<TR>
                        </form>    
                            </table>
...
sSel = "Select * From TELEFONES Where A00ID =" & sNot
...
%>
                            <table align="center" border=1 cellspacing=0 width="100%" bordercolordark="white" bordercolorlight="#808080">
                        <form action="pm_TELEFONES_opt.asp?acao=4&tp=2&sF=<% = sNot %>" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
                               <tr>
                                    <td colspan="2">
                                        <input type="button" name="news_add" value=".::Cancelar::." class="botao" onClick="go2url()">&nbsp;<input type="submit" name="frmId" class="botao" value=".::Gravar::." height=19></td>
                                </tr>
<TR>
       <TD><P><span class="aFontePT">LOCALIDADE<br></span><INPUT class=ud_caixa style="290px" value='<% = va_A01TEXTO %>' name=cp_A01TEXTO></P></TD>
       <TD><P><span class="aFontePT">TELEFONE<br></span><INPUT class=ud_caixa style="290px" value='<% = va_A02FONE %>' name=cp_A02FONE></P></TD>
</TR>
<TR>
                        </form>    
                            </table>
<% ElseIf acao = "3" Then
sNot = request.querystring("sF")
sSel = "Delete From TELEFONES Where A00ID =" & sNot
Set objRS = objConect.Execute(sSel)
response.redirect "pm_TELEFONES.asp"
ElseIf acao = "4" Then
sNot = request.querystring("sF")
Response.Expires = 0
...
If sTipo = "1" Then
sNot = request.querystring("sF")
   sSel = sSel & "INSERT INTO TELEFONES(A01TEXTO, A02FONE)"
   sSel = sSel & "VALUES ('" & va_A01TEXTO & "', '" & va_A02FONE & "')"
   Set objRS = objConect.Execute(sSel)
   response.redirect "pm_TELEFONES.asp"
...
sNot = request.querystring("sF")
   sSel = sSel & "UPDATE TELEFONES SET "
   sSel = sSel & "A01TEXTO = '" & va_A01TEXTO & "', A02FONE = '" & va_A02FONE & "' "
