...
<table cellpadding=0 cellspacing=0 width="100%" align=center>
    ...
    <tr>
        ...
        &nbsp;<font color='#FFFFFF'>CATEGORIAS</font>
        </td>
    </tr>
    <tr>
...
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_CATEGORIAS.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_CATEGORIAS.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
...
<%
   ...
   If rsTemp("A02EXIBIR") = "1" Then: iCAT	= "SIM": Else iCAT = "NÃO"
   If rsTemp("A03HASUB") = "1" Then: iSUB	= "SIM": Else iSUB = "NÃO"
