...
If Session("xUser") <> True And Session("xPass") <> True Then: response.redirect "vazou.asp"
	...
	If Mid(objRS("a05permissoes"),37,1) <> "1" Then
                        ...
                        <form action="pm_historia_opt.asp?acao=4&tp=1" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
                           <input type="hidden" name="tp" value="1">
                               <tr>
                                ...
                                <tr>
       <TD><P><span class="aFontePT">A02HISTORIA<br></span><INPUT class=ud_caixa style="WIDTH:360px" name=cp_a02historia></P></TD>
                        </form>    
                            </table>
<% ElseIf acao = "2" Then 
sNot = request.querystring("sF")
sSel = "Select * From historia Where a00id =" & sNot
...
%>
                            <table align="center" border=1 cellspacing=0 width="605" bordercolordark="white" bordercolorlight="#808080">
                        <form action="pm_historia_opt.asp?acao=4&tp=2&sF=<% = sNot %>" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
                               <tr>
                                    <td colspan="2">
                                        <input type="button" name="news_add" value=".::Cancelar::." class="botao" onClick="go2url()">&nbsp;<input type="submit" name="frmId" class="botao" value=".::Gravar::." height=19></td>
                                </tr>
<tr>
       <TD>
	   <span class="aFontePT">DESCREVA A HISTÓRIA DO MUNICÍPIO ABAIXO.<br></span><TEXTAREA class=ud_caixa style="width:100%; height:300; border-style:none;" name=cp_a02historia><% = va_a02historia %></textarea>
...
<% ElseIf acao = "3" Then
sNot = request.querystring("sF")
sSel = "Delete From historia Where a00id =" & sNot
...
If sTipo = "1" Then
sNot = request.querystring("sF")
   sSel = sSel & "INSERT INTO historia(a02historia)"
