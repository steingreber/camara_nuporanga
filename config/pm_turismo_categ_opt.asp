...
'NOME DO ARQUIVO...: pm_turismo_categ_opt.asp
'CRIADO EM.........: 31/3/2006 15:40:56
'-------------------------------------------------------------------------------
...
If acao = "1" Then
   sNome = "NOVO REGISTRO - CATEGORIA TURISMO"
ElseIf acao = "2" Then
   sNome = "EDITAR REGISTRO - CATEGORIA TURISMO"
End If
%>
...
function go2url() {
window.location = "pm_turismo_categ.asp";
}
...
If acao = "1" Then %>
                            <table align="center" border=1 cellspacing=0 width="605" bordercolordark="white" bordercolordark="#FFFFFF">
                        <form action="pm_turismo_categ_opt.asp?acao=4&tp=1" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
                           <input type="hidden" name="tp" value="1">
                               <tr>
                                ...
                                <tr>
       <TD><P><span class="aFontePT">CATEGORIA<br></span><INPUT class=ud_caixa style="WIDTH:360px" name=cp_A01CATEG></P></TD>
                        </form>    
                            </table>
<% ElseIf acao = "2" Then 
sNot = request.querystring("sF")
sSel = "Select * From turismo_categ Where A01IDTC =" & sNot
...
%>
                            <table align="center" border=1 cellspacing=0 width="605" bordercolordark="white" bordercolordark="#FFFFFF">
                        <form action="pm_turismo_categ_opt.asp?acao=4&tp=2&sF=<% = sNot %>" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
                               <tr>
                                    <td colspan="2">
                                        <input type="button" name="news_add" value=".::Cancelar::." class="botao" onClick="go2url()">&nbsp;<input type="submit" name="frmId" class="botao" value=".::Gravar::." height=19></td>
                                </tr>
                                <tr>
       <TD><P><span class="aFontePT">CATEGORIA<br></span><INPUT class=ud_caixa style="WIDTH:360px" value='<% = va_A01CATEG %>' name=cp_A01CATEG></P></TD>
                        </form>    
                            </table>
<% ElseIf acao = "3" Then
sNot = request.querystring("sF")
sSel = "Delete From turismo_categ Where A01IDTC =" & sNot
Set objRS = objConect.Execute(sSel)
response.redirect "pm_turismo_categ.asp"
...
If sTipo = "1" Then
sNot = request.querystring("sF")
   sSel = sSel & "INSERT INTO turismo_categ(A01CATEG)"
...
'***********************************************
sNot = request.querystring("sF")
   sSel = sSel & "UPDATE turismo_categ SET "
   sSel = sSel & "A01CATEG = '" & va_A01CATEG & "' "
   sSel = sSel & "WHERE A01IDTC = " & sNot
   Set objRS = objConect.Execute(sSel)
   response.redirect "pm_turismo_categ.asp"
Else
   sSel = sSel & "UPDATE turismo_categ SET "
