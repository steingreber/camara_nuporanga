...
sIdc = request("id")
If acao = "1" Then
   sNome = "NOVO REGISTRO PARA A GALERIA Nº #"& sIdc
ElseIf acao = "2" Then
   sNome = "EDITAR REGISTRO PARA A GALERIA Nº #"& sIdc
End If
%>
...
<tr>
		<td><P><span class="aFontePT">DESCRIÇÃO DA IMAGEM<br></span><input type="text" name="cp_a04descricao" class="ud_caixa" style="WIDTH:100%"></P></td>
</tr>
                        </form>    
                            </table>
<% ElseIf acao = "2" Then %>
...
<tr>
		<td><P><span class="aFontePT">DESCRIÇÃO DA IMAGEM<br></span><input type="text" name="cp_a04descricao" value="<%= va_a04descricao %>" class="ud_caixa" style="WIDTH:100%"></P></td>
</tr>
                        </form>
                            </table>
<% ElseIf acao = "3" Then
