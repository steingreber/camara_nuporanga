...
<html>
<head>
<title>banners - PageMaster 2.0</title>
...
If Trim(sValor) = "" Then
   SQL = "Select * From [banners] Order By [a00id] Desc"
Else
   If Trim(sTipo) = "Like" Then
   SQL = "Select * From [banners] Where " & sCampo & " " & sTipo & "'%" & sValor & "%'"
   Else
   SQL = "Select * From [banners] Where " & sCampo & " " & sTipo & "'" & sValor & "'"
   End If
End If
...
<tr>
	<td colspan="3" class="tabelatitulo">
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;BANNERS&nbsp;&laquo;&laquo;</span>
	</td>
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_banners_opt.asp?acao=1"><span class="aFonte">INSERIR NOVO BANNER</span></a></p>
        </td>
...
<span class="aFonte"><B>
<%
  Response.Write "<A HREF=""pm_banners.asp?Page=1""><img src='images/p2.gif' alt=Primeiro width=16 height=16 border=0> </A>"
if Current_Page > 1 then
  Response.Write "<A HREF=""pm_banners.asp?Page=" & (Current_Page - 1) & """><img src='images/p1.gif' alt=Anterior width=16 height=16 border=0> </A> " & vbCrLfelse
  Response.Write ""
end if
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_banners.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_banners.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                    ...
                    <td>
                        <table align="center" cellpadding="0" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">DESCRIÇÃO</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">EXIBIR</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">IMAGEM</span></p>
                                </td>
                            </tr>
<%
   Dim pmCorSel
   ...
   If rsTemp("a05exibir")="1" Then pmSN = "SIM": Else: pmSN = "NÃO"
   If rsTemp("a05exibir")="1" Then pmCR = "#00ff00": Else: pmCR = "#ff0000"
%>
                            <tr bgcolor="<%= pmCorSel %>">
                                <td width="63">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td align="center">
                                                <p><a href="pm_banners_opt.asp?acao=2&sF=<%= rsTemp("a00id") %>"><img src="images/botao_editar.gif" alt="EDITAR REGISTRO" width="16" height="16" border="0"></a></p>
                                            </td>
                                            <td align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_banners_opt.asp?acao=3&sF=<%= rsTemp("a00id") %>><img src="images/botao_apagar.gif" alt="EXCLUIR REGISTRO" width="16" height="16" border="0"></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td align="Left">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= rsTemp("a01descr") %></font></p>
                                </td>
                                <td align="center" bgcolor="<%= pmCR %>">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= pmSN %></font></p>
                                </td>
                                <td align="Center">
<% If rsTemp("a08tipo")="0" then %>
                                    <p><a href="javascript:fotoZoom('<%= "banners/" & rsTemp("a03imagen") %>')"><img width="150" height="50" src="<%= "banners/" & rsTemp("a03imagen")%>" border="0"></a></p>
<% Else %>
                  					 <script>ConteudoFlash('banners/<%= rsTemp("a03imagen") %>','50','150');</script>
<% End If %>
                                </td>
                            </tr>
<%
