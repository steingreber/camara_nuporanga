...
<table cellpadding=0 cellspacing=0 width="85%" align=center>
    <tr>
        ...
        <td width="853" height="34" align="center" colspan="3" class="tabelatitulo">
               ...
               <option selected value="[OptionText]">OPÇÕES</option>
               </select> 
...
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_enquetesperguntas.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_enquetesperguntas.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                    ...
                    <td>
                        <table align="center" cellpadding="0" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">OPÇÃO</span></p>
                                </td>
                            </tr>
<%
   Dim pmCorSel
