...
If Session("xUser") <> True And Session("xPass") <> True Then: response.redirect "vazou.asp"
	...
	If Mid(objRS("a05permissoes"),3,1) = "0" Then
...
If Trim(sValor) = "" Then
   SQL = "Select [a00id], [a01nome], [a02email], [a03partido] From [vereadores] Order By [a00id] Desc"
Else
   If Trim(sTipo) = "Like" Then
   SQL = "Select * From [vereadores] Where " & sCampo & " " & sTipo & "'%" & sValor & "%'"
   Else
   SQL = "Select * From [vereadores] Where " & sCampo & " " & sTipo & "'" & sValor & "'"
   End If
End If
...
<table cellpadding=0 cellspacing=0 width="98%" align=center>
    <tr>
        <td height="5" colspan="3" bgcolor="#0000CC">
        </td>
    </tr>
<tr>
	<td colspan="3" class="tabelatitulo">
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;VEREADORES&nbsp;&laquo;&laquo;</span>
	</td>
    <!-- <tr>
          <form name="frmBusca" method="post" action=pm_vereadores.asp>
        <td height="34" align="center" colspan="3" class="tabelatitulo">
               ...
               <option value="[a02email]">EMAIL</option>
               <option value="[a03partido]">PARTIDO</option>
               <option value="[a05foto]">FOTO</option>
               <option value="[a04descricao]">DESCRICAO</option>
               </select> 
    ...
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_vereadores_opt.asp?acao=1"><span class="aFonte">INSERIR NOVO VEREADOR</span></a></p>
        </td>
        <td width="90" align="right" height=20 class="tabelatitulo">
               </td>
        <td width="269" align="center" height="20" class="tabelatitulo">
		<span class="aFonte">NAVEGADOR:</span>
<span class="aFonte"><B>
<%
  Response.Write "<A HREF=""pm_vereadores.asp?Page=1""><img src='images/p2.gif' alt=Primeiro width=16 height=16 border=0 align='absmiddle'> </A>"
if Current_Page > 1 then
  Response.Write "<A HREF=""pm_vereadores.asp?Page=" & (Current_Page - 1) & """><img src='images/p1.gif' alt=Anterior width=16 height=16 border=0 align='absmiddle'> </A> " & vbCrLfelse
  Response.Write ""
end if
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_vereadores.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0 align='absmiddle'> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_vereadores.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0 align='absmiddle'>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                    ...
                    <td>
                        <table align="center" cellpadding="0" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">PARTIDO</span></p>
                                </td>
                            </tr>
<%
   Dim pmCorSel
                            ...
                            <tr bgcolor="<%= pmCorSel %>">
                                <td width="63">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td align="center">
                                                <p><a href="pm_vereadores_opt.asp?acao=2&sF=<%= rsTemp("a00id") %>"><img src="images/botao_editar.gif" alt="EDITAR REGISTRO" width="16" height="16" border="0"></a></p>
                                            </td>
                                            <td align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_vereadores_opt.asp?acao=3&sF=<%= rsTemp("a00id") %>><img src="images/botao_apagar.gif" alt="EXCLUIR REGISTRO" width="16" height="16" border="0"></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("a02email") %></font></p>
                                </td>
                                <td align="Center">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("a03partido") %></font></p>
                                </td>
                            </tr>
<%
   rsTemp.MoveNext
