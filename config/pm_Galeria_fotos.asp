...
<html>
<head>
<title>Galeria_fotos - PageMaster 2.0</title>
...
If Trim(sValor) = "" Then
   SQL = "Select * From [Galeria_fotos] Order By [a00idg] Desc"
Else
   SQL = "Select * From [Galeria_fotos] Where a01galeria =" & sValor & ""
End If
...
<tr>
	<td colspan="3" class="tabelatitulo">
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;GALERIA DE FOTOS&nbsp;&laquo;&laquo;</span>
	</td>
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_Galeria.asp"><span class="aFonte">VOLTAR</span></a></p>
        </td>
...
<span class="aFonte"><B>
<%
  Response.Write "<A HREF=""pm_Galeria_fotos.asp?Page=1""><img src='images/p2.gif' alt=Primeiro width=16 height=16 border=0> </A>"
if Current_Page > 1 then
  Response.Write "<A HREF=""pm_Galeria_fotos.asp?Page=" & (Current_Page - 1) & """><img src='images/p1.gif' alt=Anterior width=16 height=16 border=0> </A> " & vbCrLfelse
  Response.Write ""
end if
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_Galeria_fotos.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_Galeria_fotos.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                        ...
                        <table align="center" cellpadding="0" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">GALERIA NUM.</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="70%" align="center">
                                        <tr>
                                            <td width="16" align="center">
                                                <p><a href="pm_Galeria_fotos_opt.asp?acao=2&sF=<%= rsTemp("a00idg") %>"><img src="images/botao_editar.gif" width=16 height=16 border=0></a></p>
                                            </td>
                                            <td width="16" align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_Galeria_fotos_opt.asp?acao=3&sF=<%= rsTemp("a00idg") %>><img src="images/botao_apagar.gif" width=16 height=16 border=0></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td align="Center">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= rsTemp("a01galeria") %></font></p>
                                </td>
                                <td align="Center">
                                    <p><a href="javascript:fotoZoom('<%= "galeria/" & rsTemp("a02fotop") %>')"><img src="<%= "galeria/" & rsTemp("a02fotop")%>" width="60" height="60" border="0"></a></p>
                                </td>
                            </tr>
<%
   rsTemp.MoveNext
