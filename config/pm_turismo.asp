...
<html>
<head>
<title>turismo - PageMaster 2.0</title>
...
If Trim(sValor) = "" Then
   SQL = "Select [A00IDTUR], [A02NOME], [A04FONE], [A05EMAIL] From [turismo] Order By [A00IDTUR] Desc"
Else
   If Trim(sTipo) = "Like" Then
   SQL = "Select * From [turismo] Where " & sCampo & " " & sTipo & "'%" & sValor & "%'"
   Else
   SQL = "Select * From [turismo] Where " & sCampo & " " & sTipo & "'" & sValor & "'"
   End If
End If
...
<tr>
	<td colspan="3" class="tabelatitulo">
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;TURISMO&nbsp;&laquo;&laquo;</span>
	</td>
</tr>
    <tr>
          <form name="frmBusca" method="post" action=pm_turismo.asp>
        <td height="34" align="center" colspan="3" class="tabelatitulo">
               ...
               <option value="[A02NOME]">NOME</option>
               <option value="[A03END]">ENDEREÇO</option>
               <option value="[A04FONE]">FONE</option>
               <option value="[A05EMAIL]">EMAIL</option>
               <option value="[A06WEB]">WEB</option>
               </select> 
    ...
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_turismo_opt.asp?acao=1"><span class="aFonte">INSERIR NOVO REGISTRO</span></a> | <a href="pm_turismo_categ_opt.asp?acao=1"><span class="aFonte">INSERIR NOVA CATEGORIA</span></a></p>
        </td>
...
<span class="aFonte"><B>
<%
  Response.Write "<A HREF=""pm_turismo.asp?Page=1""><img src='images/p2.gif' alt=Primeiro width=16 height=16 border=0> </A>"
if Current_Page > 1 then
  Response.Write "<A HREF=""pm_turismo.asp?Page=" & (Current_Page - 1) & """><img src='images/p1.gif' alt=Anterior width=16 height=16 border=0> </A> " & vbCrLfelse
  Response.Write ""
end if
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_turismo.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_turismo.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                            ...
                            <tr bgcolor="<%= pmCorSel %>">
                                <td width="63">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td align="center">
                                                <p><a href="pm_turismo_opt.asp?acao=2&sF=<%= rsTemp("A00IDTUR") %>"><img src="images/botao_editar.gif" alt="EDITAR REGISTRO" width="16" height="16" border="0"></a></p>
                                            </td>
                                            <td align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_turismo_opt.asp?acao=3&sF=<%= rsTemp("A00IDTUR") %>><img src="images/botao_apagar.gif" alt="EXCLUIR REGISTRO" width="16" height="16" border="0"></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A02NOME") %></font></p>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A04FONE") %></font></p>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A05EMAIL") %></font></p>
                                </td>
                            </tr>
<%
   rsTemp.MoveNext
