...
<tr>
	<td colspan="3" class="tabelatitulo">
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;NOTÍCIAS&nbsp;&laquo;&laquo;</span>
	</td>
</tr>
    <tr>
    ...
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_noticias_opt.asp?acao=1"><span class="aFonte">INSERIR NOVA NOTÍCIA</span></a></p>
        </td>
...
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_noticias.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_noticias.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
