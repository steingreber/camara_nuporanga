...
<TR>
       <TD><P><span class="aFontePT">LEGENDA<br></span><INPUT class=ud_caixa style="WIDTH:290px" name=cp_a02legenda></P></TD>
       <TD><P><span class="aFontePT">FOTO (largura máxima 400 pixel)<br></span><INPUT class=ud_caixa style="WIDTH:290px" name=cp_a01foto type="file"></P></TD>
</TR>
<TR>
                        </form>    
                            </table>
...
%>
       ...
       <INPUT type="hidden" name="hcp_a01foto" value="<%=va_a01foto%>">
                               <tr>
                                ...
                                <tr>
       <TD><P><span class="aFontePT">DATA<br></span><INPUT class=ud_caixa style="WIDTH:290px" value='<% = va_a03data %>' name=cp_a03data></P></TD>
       <TD>.</TD>
</TR>
<TR>
       <TD><P><span class="aFontePT">LEGENDA<br></span><INPUT class=ud_caixa style="WIDTH:290px" value='<% = va_a02legenda %>' name=cp_a02legenda></P></TD>
       <TD><P><span class="aFontePT">FOTO (largura máxima 400 pixel) - <a href="javascript:fotoZoom('<%= "galeria/" & va_a01foto%>')">VER AQUIVO</a></span><br><INPUT class=ud_caixa style="WIDTH:290px" name=cp_a01foto type="file"><BR></P>
</TR>
<TR>
                        </form>    
                            </table>
...
'===============================================
If va_a01foto <> "" Then
Set selectfig = objConect.Execute("SELECT * FROM galeria WHERE a01foto = '" & FileName & "';")
...
End If
   ...
   sSel = sSel & "INSERT INTO galeria(a03data, a04idpas, a02legenda, a01foto)"
