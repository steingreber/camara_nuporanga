...
if (theForm.cp_A01CATEG1 && !EW_hasValue(theForm.cp_A01CATEG1, "TEXT" )) {
  ...
  if (theForm.cp_A03HASUB && !EW_hasValue(theForm.cp_A03HASUB, "RADIO" )) {
          if (!EW_onError(theForm, theForm.cp_A03HASUB, "RADIO", "Selecione um valor para SUB CATEGORIAS!"))
            return false;
    }
  return true;
}
...
<table cellpadding="0" cellspacing="0" width="70%" align="center">
    ...
    <tr>
        <td" align="center" valign="top">
            <table width="70%" border="1" cellspacing="0" align="center" bordercolorlight="#000000" bordercolordark="#FFFFFF" bgcolor="#FFFFFF">
                <tr>
                    <td>
<%
Dim sSel, sNot
...
<TR>
       <td colspan="2"><P><span class="aFontePT">CATEGORIA<br></span><INPUT value="" class=ud_caixa style="WIDTH:100%" name=cp_A01CATEG1></P></td>
</TR>
<TR>
	   <TD><P><span class="aFontePT">EXIBIR&nbsp;</span>
                    <input type="radio" name="cp_A02EXIBIR" value="1" checked><span class="fontTD">SIM</span>&nbsp;
                    <input type="radio" name="cp_A02EXIBIR" value="0"><span class="fontTD">NÃO</span>&nbsp;
       </P></TD>
	   <TD><P><span class="aFontePT">HÁ SUB CATEGORIAS PARA ESTE ITEM?&nbsp;</span>
                    <input type="radio" name="cp_A03HASUB" value="1"><span class="fontTD">SIM</span>&nbsp;
                    <input type="radio" name="cp_A03HASUB" value="0" checked><span class="fontTD">NÃO</span>&nbsp;
       </P></TD>
</TR>
                        </form>    
                            </table>
...
<TR>
       <td colspan="2"><P><span class="aFontePT">CATEGORIA<br></span><INPUT class=ud_caixa style="WIDTH:100%" value='<% = va_A01CATEG1 %>' name=cp_A01CATEG1></P></td>
</TR>
<TR>
	   <TD><P><span class="aFontePT">EXIBIR&nbsp;</span>
                    <input type="radio" name="cp_A02EXIBIR" value="1"<% If va_A02EXIBIR = "1" Then %> checked<% End If %>><span class="fontTD">SIM</span>&nbsp;
                    <input type="radio" name="cp_A02EXIBIR" value="0"<% If va_A02EXIBIR = "0" Then %> checked<% End If %>><span class="fontTD">NÃO</span>
       </P></TD>
	   <TD><P><span class="aFontePT">HÁ SUB CATEGORIAS PARA ESTE ITEM?&nbsp;</span>
                    <input type="radio" name="cp_A03HASUB" value="1"<% If va_A03HASUB = "1" Then %> checked<% End If %>><span class="fontTD">SIM</span>&nbsp;
                    <input type="radio" name="cp_A03HASUB" value="0"<% If va_A03HASUB = "0" Then %> checked<% End If %>><span class="fontTD">NÃO</span>
       </P></TD>
</TR>
                        </form>    
                            </table>
...
If sTipo = "1" Then
sNot = request.querystring("sF")
   sSel = sSel & "INSERT INTO CATEGORIAS(A01CATEG1, A02EXIBIR, A03HASUB)"
   sSel = sSel & "VALUES ('" & va_A01CATEG1 & "', '" & va_A02EXIBIR & "', '" & va_A02EXIBIR & "')"
   Set objRS = objConect.Execute(sSel)
   response.redirect "pm_CATEGORIAS.asp"
...
sNot = request.querystring("sF")
   ...
   sSel = sSel & "A01CATEG1 = '" & va_A01CATEG1 & "', A02EXIBIR = '" & va_A02EXIBIR & "', A03HASUB = '" & va_A03HASUB & "' "
