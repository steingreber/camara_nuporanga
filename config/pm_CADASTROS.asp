...
If Session("xUser") <> True And Session("xPass") <> True Then: response.redirect "vazou.asp"
	...
	If Mid(objRS("a05permissoes"),15,1) <> "1" Then
...
If Trim(sValor) = "" Then
   SQL = "Select [A00ID], [A01NOME], [A19DATACAD], [A20LIBERADO], [A21LIBERADOATEH] From [CADASTROS] Order By [A01NOME]"
   iLabel = "Buscar registro"
Else
   If Trim(sTipo) = "Like" Then
   SQL = "Select * From [CADASTROS] Where " & sCampo & " " & sTipo & "'%" & sValor & "%'"
   Else
   SQL = "Select * From [CADASTROS] Where " & sCampo & " " & sTipo & "'" & sValor & "'"
   End If
   iLabel = "Exibir todos..."
...
<table cellpadding=0 cellspacing=0 width="98%" align=center>
    ...
    <tr>
		...
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;CADASTROS DA INTRANET&nbsp;&laquo;&laquo;</span>
        </td>
    </tr>
    <tr>
          <form name="frmBusca" method="post" action=pm_CADASTROS.asp>
    <td height="34" align="center" colspan="3" class="tabelatitulo">
               ...
               <option value="[A02ENDERECO]">ENDERECO</option>
               <option value="[A06CIDADE]">CIDADE</option>
               <option value="[A07ESTADO]">ESTADO</option>
               <option value="[A08FONE]">FONE</option>
               <option value="[A09CELULAR]">CELULAR</option>
               <option value="[A10EMAIL]">EMAIL</option>
               <option value="[A17SENHA]">SENHA</option>
               <option value="[A11CPF]">CPF</option>
               <option value="[A12RG]">RG</option>
               </select> 
    ...
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_CADASTROS_opt.asp?acao=1"><span class="aFonte">NOVO REGISTRO</span></a></p>
        </td>
...
<span class="aFonte"><B>
<%
  Response.Write "<A HREF=""pm_CADASTROS.asp?Page=1""><img src='images/p2.gif' alt=Primeiro width=16 height=16 border=0> </A>"
if Current_Page > 1 then
  Response.Write "<A HREF=""pm_CADASTROS.asp?Page=" & (Current_Page - 1) & """><img src='images/p1.gif' alt=Anterior width=16 height=16 border=0> </A> " & vbCrLfelse
  Response.Write ""
end if
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_CADASTROS.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_CADASTROS.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                    ...
                    <td>
                        <table align="center" cellpadding="0" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">CADASTRO</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">LIBERADO?</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">ATÉ...</span></p>
                                </td>
                            </tr>
<%
   Dim pmCorSel, sCor, sFra, sImg
   pmCorSel = "#E7E7E7"
   ...
   If rsTemp("A20LIBERADO") = "1" Then: sCor = "#00ff00": Else: sCor = "#ff0000"
   If rsTemp("A20LIBERADO") = "1" Then: sFra = "SIM": Else: sFra = "NÃO"
   If rsTemp("A20LIBERADO") = "1" Then: sImg = "ok": Else: sImg = "no"
%>
                            <tr bgcolor="<%= pmCorSel %>">
                                <td width="63">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td align="center">
                                                <p><a href="pm_CADASTROS_opt.asp?acao=2&sF=<%= rsTemp("A00ID") %>"><img src="images/botao_editar.gif" alt='EDITAR' width=16 height=16 border=0></a></p>
                                            </td>
                                            <td align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_CADASTROS_opt.asp?acao=3&sF=<%= rsTemp("A00ID") %>><img src="images/botao_apagar.gif" alt='EXCLUIR' width=16 height=16 border=0></a></p>
                                            </td>
                                            <td align="center">
                                                <p><a href=pm_CADASTROS_ACESSO.asp?idm=<%= rsTemp("A00ID") %>&acao=<%= sImg %>><img src="images/user-<%= sImg %>.gif" alt="Definir acesso" border="0"></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= rsTemp("A01NOME") %></font></p>
                                </td>
                                <td align="Center">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= rsTemp("A19DATACAD") %></font></p>
                                </td>
                                <td align="center" bgcolor="<%= sCor %>">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= sFra %></font></p>
                                </td>
                                <td align="Center">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= rsTemp("A21LIBERADOATEH") %></font></p>
                                </td>
                            </tr>
<%
   rsTemp.MoveNext
