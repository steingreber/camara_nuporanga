...
this.btnList = {
    ...
    "justifyright":   ['JustifyRight',         'Alinha a direita',   'editor_action(this.id)',  'ed_align_right.gif'],
    "orderedlist":    ['InsertOrderedList',    'Lista numérica',     'editor_action(this.id)',  'ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  'Lista de marcadores','editor_action(this.id)',  'ed_list_bullet.gif'],
    "outdent":        ['Outdent',              'Recuar paragrafo',   'editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               'Avançar paragraco',  'editor_action(this.id)',  'ed_indent_more.gif'],
    ...
    "createlink":     ['CreateLink',           'Hiper link',         'editor_action(this.id)',  'ed_link.gif'],
    ...
    "htmlmode":       ['HtmlMode',             'Ver código fonte',   'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
    "popupeditor":    ['popupeditor',          'Expandir editor',    'editor_action(this.id)',  'fullscreen_maximize.gif'],
