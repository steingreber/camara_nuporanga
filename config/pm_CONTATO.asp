...
If Session("xUser") <> True And Session("xPass") <> True Then: response.redirect "vazou.asp"
	...
	If Mid(objRS("a05permissoes"),12,1) <> "1" Then
...
If Trim(sValor) = "" Then
   SQL = "Select [A00ID], [A01NOME], [A02EMAIL] From [CONTATO] Order By [A01NOME]"
   iLabel = "Buscar registro"
Else
   If Trim(sTipo) = "Like" Then
   SQL = "Select * From [CONTATO] Where " & sCampo & " " & sTipo & "'%" & sValor & "%'"
   Else
   SQL = "Select * From [CONTATO] Where " & sCampo & " " & sTipo & "'" & sValor & "'"
   End If
   iLabel = "Exibir todos..."
...
<table cellpadding=0 cellspacing=0 width="98%" align=center>
    ...
    <tr>
		...
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;CONTATOS EMAIL&nbsp;&laquo;&laquo;</span>
        </td>
    </tr>
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_CONTATO_opt.asp?acao=1"><span class="aFonte">NOVO REGISTRO</span></a></p>
        </td>
                            ...
                            <tr bgcolor="<%= pmCorSel %>">
                                <td width="63">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td align="center">
                                                <p><a href="pm_CONTATO_opt.asp?acao=2&sF=<%= rsTemp("A00ID") %>"><img src="images/botao_editar.gif" alt='EDITAR' width=16 height=16 border=0></a></p>
                                            </td>
                                            <td align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_CONTATO_opt.asp?acao=3&sF=<%= rsTemp("A00ID") %>><img src="images/botao_apagar.gif" alt='EXCLUIR' width=16 height=16 border=0></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
