...
If Session("xUser") <> True And Session("xPass") <> True Then: response.redirect "vazou.asp"
	...
	If Mid(objRS("a05permissoes"),24,1) = "0" Then
...
If Trim(sValor) = "" Then
   SQL = "Select [A00ID], [A01TEXTO], [A02FONE] From [TELEFONES] Order By [A01TEXTO]"
   iLabel = "Buscar registro"
Else
   If Trim(sTipo) = "Like" Then
   SQL = "Select * From [TELEFONES] Where " & sCampo & " " & sTipo & "'%" & sValor & "%'"
   Else
   SQL = "Select * From [TELEFONES] Where " & sCampo & " " & sTipo & "'" & sValor & "'"
   End If
   iLabel = "Exibir todos..."
...
<table cellpadding=0 cellspacing=0 width="98%" align=center>
    ...
    <tr>
		...
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;TELEFONES ÚTEIS&nbsp;&laquo;&laquo;</span>
        </td>
    </tr>
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_TELEFONES_opt.asp?acao=1"><span class="aFonte">NOVO REGISTRO</span></a></p>
        </td>
                        ...
                        <table align="center" cellpadding="0" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">LOCALIDADE</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">TELEFONE</span></p>
                                </td>
                            </tr>
<%
   Dim pmCorSel
                            ...
                            <tr bgcolor="<%= pmCorSel %>">
                                <td width="63">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td align="center">
                                                <p><a href="pm_TELEFONES_opt.asp?acao=2&sF=<%= rsTemp("A00ID") %>"><img src="images/botao_editar.gif" alt='EDITAR' width=16 height=16 border=0></a></p>
                                            </td>
                                            <td align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_TELEFONES_opt.asp?acao=3&sF=<%= rsTemp("A00ID") %>><img src="images/botao_apagar.gif" alt='EXCLUIR' width=16 height=16 border=0></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td align="Left">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= rsTemp("A02FONE") %></font></p>
                                </td>
                            </tr>
<%
   rsTemp.MoveNext
