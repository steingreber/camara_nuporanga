...
ElseIf acao = "2" Then
   sNome = "EDITAR REGISTRO - ADMINISTRAÇÃO DO MUNICÍPIO"
End If
%>
...
If Session("xUser") <> True And Session("xPass") <> True Then: response.redirect "vazou.asp"
	...
	If Mid(objRS("a05permissoes"),35,1) = "0" Then
...
<table cellpadding="0" cellspacing="0" width="70%" align="center">
    ...
    <tr>
        <td" align="center" valign="top">
            <table width="70%" border="1" cellspacing="0" align="center" bordercolordark="#FFFFFF" bgcolor="#FFFFFF">
                <tr>
                    <td>
<%
Dim sSel, sNot
If acao = "1" Then %>
                        ...
                        <form action="pm_administracao_opt.asp?acao=4&tp=1" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
...
sSel = "Select * From administracao Where a00id =" & sNot
...
%>
                            <table align="center" border=1 cellspacing=0 width="100%" bordercolordark="white" bordercolordark="#FFFFFF">
                        <form action="pm_administracao_opt.asp?acao=4&tp=2&sF=<% = sNot %>" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
                               <tr>
                                    <td colspan="2">
                                        <input type="button" name="news_add" value=".::Cancelar::." class="botao" onClick="go2url()">&nbsp;<input type="submit" name="frmId" class="botao" value=".::Gravar::." height=19></td>
                                </tr>
                                <tr>
       <TD>
	   <span class="aFontePT">DIGITE O TEXTO ABAIXO SOBRE A ADMINISTRAÇÃO<br></span><TEXTAREA class=ud_caixa style="width:100%; height:200; border-style:none;" name=cp_a01texto><% = va_a01texto %></textarea>
...
<% ElseIf acao = "3" Then
sNot = request.querystring("sF")
sSel = "Delete From administracao Where a00id =" & sNot
Set objRS = objConect.Execute(sSel)
response.redirect "pm_administracao.asp"
...
If sTipo = "1" Then
sNot = request.querystring("sF")
   sSel = sSel & "INSERT INTO administracao(a01texto, a02desc)"
...
'***********************************************
sNot = request.querystring("sF")
   sSel = sSel & "UPDATE administracao SET "
