...
If acao = "1" Then
   sNome = "NOVO REGISTRO - LINKS"
ElseIf acao = "2" Then
   sNome = "EDITAR REGISTRO - LINKS"
End If
%>
...
If acao = "1" Then %>
                            <table align="center" border=1 cellspacing=0 width="605" bordercolordark="white" bordercolorlight="#808080">
                        <form action="pm_links_opt.asp?acao=4&tp=1" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
...
sSel = "Select * From links Where a00id =" & sNot
...
%>
                            <table align="center" border=1 cellspacing=0 width="605" bordercolordark="white" bordercolorlight="#808080">
                        <form action="pm_links_opt.asp?acao=4&tp=2&sF=<% = sNot %>" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
                               <tr>
                                    <td colspan="2">
                                        <input type="button" name="news_add" value=".::Cancelar::." class="botao" onClick="go2url()">&nbsp;<input type="submit" name="frmId" class="botao" value=".::Gravar::." height=19></td>
                                </tr>
...
<%
sNot = request.querystring("sF")
sSel = "Delete From links Where a00id =" & sNot
Set objRS = objConect.Execute(sSel)
response.redirect "pm_links.asp"
%>
<%
ElseIf acao = "4" Then
sNot = request.querystring("sF")
...
If sTipo = "1" Then
sNot = request.querystring("sF")
   sSel = sSel & "INSERT INTO links(a01texto, a02link, a03target)"
