...
If Trim(sValor) = "" Then
   SQL = "Select [a00id], [a03data], [a02legenda] From [galeria] Order By [a00id] Desc"
Else
...
<tr>
	<td colspan="3" class="tabelatitulo">
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;GALERIA DE FOTOS DO MUNICÍPIO&nbsp;&laquo;&laquo;</span>
	</td>
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_galeria_opt.asp?acao=1"><span class="aFonte">NOVA FOTO PARA A GALERIA</span></a></p>
        </td>
...
<span class="aFonte"><B>
<%
  Response.Write "<A HREF=""pm_galeria.asp?Page=1""><img src='images/p2.gif' alt=Primeiro width=16 height=16 border=0> </A>"
if Current_Page > 1 then
  Response.Write "<A HREF=""pm_galeria.asp?Page=" & (Current_Page - 1) & """><img src='images/p1.gif' alt=Anterior width=16 height=16 border=0> </A> " & vbCrLfelse
  Response.Write ""
end if
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_galeria.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_galeria.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                                ...
                                <td width="63">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            ...
                                            <td align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_galeria_opt.asp?acao=3&sF=<%= rsTemp("a00id") %>><img src="images/botao_apagar.gif" alt="EXCLUIR REGISTRO" width="16" height="16" border="0"></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
