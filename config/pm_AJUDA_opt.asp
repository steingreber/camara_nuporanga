...
'NOME DO ARQUIVO...: pm_AJUDA_opt.asp
'CRIADO EM.........: 17/5/2007 11:03:45
'-------------------------------------------------------------------------------
...
If acao = "1" Then
   sNome = "NOVO REGISTRO - AJUDA"
ElseIf acao = "2" Then
   sNome = "EDITAR REGISTRO - AJUDA"
End If
%>
<!--#include file="_cnx.asp"-->
<html>
<head>
<title>AJUDA - PageMaster 2.0 :::.</title>
...
if (theForm.cp_a02desc && !EW_hasValue(theForm.cp_a02desc, "TEXTAREA" )) {
            if (!EW_onError(theForm, theForm.cp_a02desc, "TEXTAREA", "Informe um valor para o campo DESC"))
                return false;
        }
  return true;
}
...
If acao = "1" Then %>
                        ...
                        <form action="pm_AJUDA_opt.asp?acao=4&tp=1" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
...
<TR>
       <TD><P><span class="aFontePT">TITULO<br></span><INPUT value="" class=ud_caixa style="WIDTH:100%" name=cp_a01titulo></P></TD>
</TR>
<TR>
       <TD>
           <span class="aFontePT">DESCRI플O DA AJUDA<br></span><TEXTAREA class=ud_caixa style="width:100%; height:150; border-style:none;" name=cp_a02desc></textarea>
           <script language="javascript1.2">
           editor_generate('cp_a02desc'); // field, width, height
           </script>
         </TD>
</TR>
                        </form>    
...
%>
                            <table align="center" border=1 cellspacing=0 width="100%" bordercolordark="white" bordercolorlight="#808080">
                        <form action="pm_AJUDA_opt.asp?acao=4&tp=2&sF=<% = sNot %>" method="post" name="frmInc" enctype="multipart/form-data" id="frmInc" onSubmit="return Validator(this);">
                               <tr>
                                    <td colspan="2">
                                        <input type="button" name="news_add" value=".::Cancelar::." class="botao" onClick="go2url()">&nbsp;<input type="submit" name="frmId" class="botao" value=".::Gravar::." height=19></td>
                                </tr>
<TR>
       <TD><P><span class="aFontePT">TITULO<br></span><INPUT class=ud_caixa style="WIDTH:100%" value='<% = va_a01titulo %>' name=cp_a01titulo></P></TD>
</TR>
<TR>
	   <TD>
         <span class="aFontePT">DESC<br></span><TEXTAREA class=ud_caixa style="width:100%; height:150; border-style:none;" name=cp_a02desc><% = va_a02desc %></textarea>
         <script language="javascript1.2">
         editor_generate('cp_a02desc'); // field, width, height
         </script>
       </TD>
...
<% ElseIf acao = "3" Then
sNot = request.querystring("sF")
sSel = "Delete From AJUDA Where a00id =" & sNot
Set objRS = objConect.Execute(sSel)
response.redirect "pm_AJUDA.asp"
ElseIf acao = "4" Then
sNot = request.querystring("sF")
Response.Expires = 0
...
If sTipo = "1" Then
sNot = request.querystring("sF")
   sSel = sSel & "INSERT INTO AJUDA(a01titulo, a02desc)"
   sSel = sSel & "VALUES ('" & va_a01titulo & "', '" & va_a02desc & "')"
   Set objRS = objConect.Execute(sSel)
   response.redirect "pm_AJUDA.asp"
...
sNot = request.querystring("sF")
   sSel = sSel & "UPDATE AJUDA SET "
   sSel = sSel & "a01titulo = '" & va_a01titulo & "', a02desc = '" & va_a02desc & "' "
