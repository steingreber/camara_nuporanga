...
If Trim(sValor) = "" Then
   SQL = "Select * From [CORES] Order By [a00id] Desc"
   iLabel = "Buscar registro"
Else
   If Trim(sTipo) = "Like" Then
   SQL = "Select * From [CORES] Where " & sCampo & " " & sTipo & "'%" & sValor & "%'"
   Else
   SQL = "Select * From [CORES] Where " & sCampo & " " & sTipo & "'" & sValor & "'"
   End If
   iLabel = "Exibir todos..."
...
<table cellpadding=0 cellspacing=0 width="98%" align=center>
    ...
    <tr>
		...
		&nbsp;<span class="aFonte">&raquo;&raquo;&nbsp;CORES DO PORTAL&nbsp;&laquo;&laquo;</span>
        </td>
    </tr>
    <tr>
          <form name="frmBusca" method="post" action=pm_CORES.asp>
    <td height="34" align="center" colspan="3" class="tabelatitulo">
               <p><select name="q" size=1 class="ud_caixa">
               <option value="[a08NomeCor]">NOME DA COR</option>
               <option value="[a06Tamplate]">LAYOUT</option>
               <option value="[a01corTopoBase]">COR TOPO BASE</option>
               <option value="[a02corTopoTabela]">COR TOPO TABELA</option>
               <option value="[a03corCorpoTabela]">COR CORPO TABELA</option>
               <option value="[a04corFonte]">COR FONTE</option>
               <option value="[a05corLink]">COR LINK</option>
               </select> 
    ...
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_CORES_opt.asp?acao=1"><span class="aFonte">NOVO REGISTRO</span></a></p>
        </td>
...
<span class="aFonte"><B>
<%
  Response.Write "<A HREF=""pm_CORES.asp?Page=1""><img src='images/p2.gif' alt=Primeiro width=16 height=16 border=0> </A>"
if Current_Page > 1 then
  Response.Write "<A HREF=""pm_CORES.asp?Page=" & (Current_Page - 1) & """><img src='images/p1.gif' alt=Anterior width=16 height=16 border=0> </A> " & vbCrLfelse
  Response.Write ""
end if
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_CORES.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_CORES.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                        ...
                        <table align="center" cellpadding="0" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">NOME DA COR</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">TEMPLATE</span></p>
                                </td>
                            </tr>
<%
   Dim pmCorSel
                            ...
                            <tr bgcolor="<%= pmCorSel %>">
                                <td width="63">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td align="center">
                                                <p><a href="pm_CORES_opt.asp?acao=2&sF=<%= rsTemp("A00ID") %>"><img src="images/botao_editar.gif" alt='EDITAR' width=16 height=16 border=0></a></p>
                                            </td>
                                            <td align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_CORES_opt.asp?acao=3&sF=<%= rsTemp("A00ID") %>><img src="images/botao_apagar.gif" alt='EXCLUIR' width=16 height=16 border=0></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= rsTemp("a08NomeCor") %></font></p>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="'Trebuchet MS', Verdana, Arial"><%= rsTemp("a06Tamplate") %></font></p>
                                </td>
                            </tr>
<%
   rsTemp.MoveNext
