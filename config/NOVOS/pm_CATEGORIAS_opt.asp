...
<TR>
       <TD><P><span class="aFontePT">HA SUB-CATEG&nbsp;</span>
                    ...
                    <input type="radio" name="cp_A03HASUB" value="0"><span class="fontTD">NÃO</span>&nbsp;
                    <input type="radio" name="cp_A03HASUB" value="0"><span class="fontTD">NÃO</span>&nbsp;
       </P></TD>
...
<TR>
       ...
       <TD><P><span class="aFontePT">EXIBIR<br></span>
                    ...
                    <input type="radio" name="cp_A02EXIBIR" value="0"<% If va_A02EXIBIR = "0" Then %> checked<% End If %>><span class="fontTD">NÃO</span><br>
       </P></TD>
</TR>
<TR>
       <TD><P><span class="aFontePT">HA SUB-CATEG<br></span>
                    ...
                    <input type="radio" name="cp_A03HASUB" value="0"<% If va_A03HASUB = "0" Then %> checked<% End If %>><span class="fontTD">NÃO</span><br>
                    <input type="radio" name="cp_A03HASUB" value="0"<% If va_A03HASUB = "0" Then %> checked<% End If %>><span class="fontTD">NÃO</span><br>
       </P></TD>
